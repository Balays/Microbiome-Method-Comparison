...
writetables  <- T
save.Figs    <- F
res.dir      <- 'Toti_all_comp_Inv';dir.create(res.dir)
...
## taxonomic ranks
ranks <- c("superkingdom", "speclum", "class", "order", "family", "genus", "species")
...
```{r, speclum-level plot, fig.height=fig.height.vr, fig.width = fig.width.vr, eval=multiV[2]}
